...
$nama_file='LAPORAN PENGUPAHAN PROYEK'; //Beri nama file PDF hasil.
...
<html>
<head>
    <title>LAPORAN PENGUPAHAN PROYEK <?php echo $nik;?></title>
    <style>
        *
        {
            margin:0;
...
?>
    <table class="heading" style="width:100%;">
		...
		<br /><p style="text-align:center; font-size: 9px; font-weight:bold;">
		LAPORAN PENGUPAHAN PROYEK
		<?php
    ...
    <div id="content">
        ...
        <?php
            ...
            <tr>
                ...
                <td style="width:15%;"><b>Nama Pekerja</b></td>
        ...
        <div id="invoice_total" align="right">
				<?php
				$query_total_upah="SELECT SUM(total)As total_upah FROM absensi WHERE id_proyek ='$id_proyek'";
				...
				$format_indonesia = number_format ($number, 2, ',', '.');
				echo'
				<br /><p style="text-align:right; font-size: 11px; font-weight:bold;">Jumlah Total = RP. '.$format_indonesia.'</p>
				<table>
				<tr>
				</tr>
				</table>
...
$mpdf->Output($nama_file." (ID PROYEK ".$id_proyek.")-(TANGGAL ".date("d-m-Y").")".".pdf" ,'I');
exit; 
?>
</body>
</html>