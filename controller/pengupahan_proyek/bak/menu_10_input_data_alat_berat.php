...
if(isset($_POST['menu_10_input_data_alat_berat']))
{
	echo"<title>INPUT DATA ALAT BERAT</title>";
...
$val_alamat_proyek = $_POST['val_alamat_proyek'];
$val_nama_proyek = $_POST['val_nama_proyek'];
$val_divisi = $_POST['val_divisi'];
//
